...
//SET OVERFLOW 128US, PRESCALER //011-->64 */
#define TIM0_overflow1000us()            TCCR0B &= ~((1<<CS02) | (1<<CS00); TCCR0B |= (1<<CS01));
//SET OVERFLOW 128US, PRESCALER //100-->256 */
#define TIM0_overflow_4096us()          TCCR0B &= ~((1<<CS02) | (1<<CS00); TCCR0B  |= (1<<CS01));
//SET OVERFLOW 128US, PRESCALER //101-->1024 */
#define TIM0_overflow_16384us()          TCCR0B &= ~((1<<CS02) | (1<<CS00); TCCR0B |= (1<<CS01));
...
#define TIM2_overflow_16384us()    TCCR2B &= ~(1<<CS21); TCCR2B |= (1<<CS22) | (1<<CS20);
